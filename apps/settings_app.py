...
class MainActivity(Activity):
    def __init__(self):
        ...
        self.objlist = [('请勿打扰', fonts.SYMBOL.BELL_DISABLE, 's', self.set_bool_obj, ('do_not_disturb', False, None)),
                        ...
                        ('熄屏(s)', lv.SYMBOL.IMAGE, 'i', self.set_slider_obj, ('screenoff_timeout', 30, None, 'ScreenOff', 's', 10, 120, None, None, 10)),
                        ...
                        '高级',
                        ('省电模式', lv.SYMBOL.BATTERY_1, 's', self.set_bool_obj, ('powersave', False, None)),
                        ('省电阈值', lv.SYMBOL.BATTERY_1, 'i', self.set_slider_obj, ('powersave_timeout', 30, None, 'PowerSave', '分钟', 0, 60, None, None, 1)),
