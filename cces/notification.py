...
class NotificationCenter(Activity): # 通知中心
    def setup(self):
        ...
        self.notify_remove.set_size(240, 240)
        self.notify_remove.align(lv.ALIGN.RIGHT_MID, 200, 0)
        ...
        self.notify_next.set_style_bg_color(lv.color_hex(0xFFFFFF), lv.PART.MAIN | lv.STATE.DEFAULT)
